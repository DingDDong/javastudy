...
class ZoneIdDemo{
        public static void main(String[] args) {
            ZonedDateTime date = ZonedDateTime.of(LocalDateTime.of
                    (2019, 4, 25, 11 , 20), ZoneId.of("Asia/Seoul"));
            ...
            DateTimeFormatter fm3 = DateTimeFormatter.ofPattern("yyyy-MM-d, H:m:ss VV");
